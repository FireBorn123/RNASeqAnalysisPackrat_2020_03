...
Heatmap(
        ...
        right_annotation = rowAnnotation(
          Col1 = if(ShowLocus == TRUE){
            anno_text(FoldChangeData$locus, location = unit(0.5, "mm"), gp = gpar(fontsize = RowLabelTextCell))}),
...
FinalHeatmap = HeatmapCustomized(DataSet = Combined_List_Analysis_Shrunk2, 
                                 ...
                                 ShowLocus = TRUE, 
                                 ShowNucleotidePAO1Locus = FALSE, 
                                 ShowProteinPAO1Locus = FALSE,
                                 ShowGeneCol = FALSE, 
                                 ShowNucleotidePAO1ID = FALSE,
