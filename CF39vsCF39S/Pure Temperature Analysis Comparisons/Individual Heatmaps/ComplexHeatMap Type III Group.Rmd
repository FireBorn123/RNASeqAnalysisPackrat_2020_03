...
LoadedFlagellarData <- read_delim("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39vsCF39S/Pure Temperature Analysis Comparisons/Individual Heatmaps/Cut Data Sets/Class III Partial Dataset.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
...
```{r}
png("ClassIII_Clustered_3.png", width = 18, height = 12, res = 300, units = "cm")
HeatmapTest
dev.off()
```
