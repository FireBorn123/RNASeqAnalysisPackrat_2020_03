...
LoadedFlagellarData <- read_delim("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39vsCF39S/Pure Temperature Analysis Comparisons/Individual Heatmaps/Cut Data Sets/Flagella Genes Partial Dataset.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
...
```{r}
png("Flagella_Clustered_1.png", width = 20, height = 13, res = 300, units = "cm")
HeatmapTest
dev.off()
```
