...
HeatmapTest <- Heatmap(
        ...
        Col6 = anno_text(DataSet$SuspectedProtein, location = unit(0.75, "mm"), gp = gpar(fontsize = RowLabelTextCell, fontface = "italic")),
...
```{r}
png("T6SS_Numbered_1.png", width = 20, height = 7, res = 300, units = "cm")
