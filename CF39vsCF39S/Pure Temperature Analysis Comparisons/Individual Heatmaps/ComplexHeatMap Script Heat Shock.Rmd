...
LoadedHeatShockData <- read_delim("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39vsCF39S/Pure Temperature Analysis Comparisons/Individual Heatmaps/Cut Data Sets/Heat Shock Genes Full Dataset.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
...
```{r, eval=FALSE}
png("HeatShock_Clustered_1.png", width = 19, height = 8.5, res = 300, units = "cm")
HeatmapTest
dev.off()
```

```{r}
png("HeatShock_Clustered_3.png", width = 17, height = 10, res = 300, units = "cm")
HeatmapTest
dev.off()
```
