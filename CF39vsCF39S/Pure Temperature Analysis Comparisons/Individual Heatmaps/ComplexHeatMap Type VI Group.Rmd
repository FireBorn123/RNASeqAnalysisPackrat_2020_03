...
LoadedFlagellarData <- read_delim("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39vsCF39S/Pure Temperature Analysis Comparisons/Individual Heatmaps/Cut Data Sets/Class VI Partial Dataset - 1.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
...
```{r}
png("ClassVI_Clustered_2.png", width = 18, height = 9, res = 300, units = "cm")
HeatmapTest
dev.off()
```
