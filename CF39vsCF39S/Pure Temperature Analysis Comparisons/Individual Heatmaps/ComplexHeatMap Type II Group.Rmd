...
LoadedFlagellarData <- read_delim("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39vsCF39S/Pure Temperature Analysis Comparisons/Individual Heatmaps/Cut Data Sets/Class II Full Dataset.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
...
```{r}
png("ClassII_Clustered_2.png", width = 15, height = 11, res = 300, units = "cm")
HeatmapTest
dev.off()
```
