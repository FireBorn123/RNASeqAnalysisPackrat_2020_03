...
LoadedFlagellarData <- read_delim("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39vsCF39S/Pure Temperature Analysis Comparisons/Individual Heatmaps/Cut Data Sets/Class V Partial Dataset - 1.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
...
```{r}
png("ClassV_Clustered_4.png", width = 20, height = 11.5, res = 300, units = "cm")
HeatmapTest
dev.off()
```
