...
#Actual Dataset
## Loading and formatting the CF39 vs CF39S 29 C Dataset
Load in the data from the file called "29 vs 29 Counts Table.csv". This file should be located along the specified path.
