...
#Actual Dataset
## Loading and formatting the CF39 vs CF39S 41 C Dataset
Load in the data from the file called "41 vs 41 Counts Table.csv". This file should be located along the specified path.
