...
#PC Path
setwd("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39vsCF39S/41 vs 41/My DESEQ Script")
#Laptop Path
#Set Library Directory
#.libPaths(c(""))
#setwd("")
...
Exp41_vs_41 <- read.csv("../../SourceRNASEQCountsForDESEQ/41 vs 41 Counts Table.csv")
TestSet <- Exp41_vs_41

#Variables
ColNameLables <- c("CF39S_41-1","CF39S_41-2", "CF39S_41-3", "CF39C_41-1","CF39C_41-2", "CF39C_41-3")
```
