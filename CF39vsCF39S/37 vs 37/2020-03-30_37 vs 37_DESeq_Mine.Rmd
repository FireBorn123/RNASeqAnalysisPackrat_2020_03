...
#PC Path
setwd("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39vsCF39S/37 vs 37/My DESEQ Script")
#Laptop Path
#setwd("C:/Users/Trevor/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeq Expression Profiles 1/RNASeq Data Files Analysis/CF39 vs CF39S/37 vs 37/My DESEQ Script")
...
#Actual Dataset
## Loading and formatting the CF39 vs CF39S 37 C Dataset
Load in the data from the file called "37 vs 37 Counts Table.csv". This file should be located along the specified path.

```{r}
#Load data data from my computer
Exp37_vs_37 <- read.csv("../../SourceRNASEQCountsForDESEQ/37 vs 37 Counts Table.csv")
TestSet <- Exp37_vs_37

#Variables
ColNameLables <- c("CF39S_37-1","CF39S_37-2", "CF39S_37-3", "CF39C_37-1","CF39C_37-2", "CF39C_37-3")
```
