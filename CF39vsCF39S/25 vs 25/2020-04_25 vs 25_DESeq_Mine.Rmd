...
#PC Path
setwd("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39vsCF39S/25 vs 25/My DESEQ Script")
#Laptop Path
#Set Library Directory
#.libPaths(c(""))
#setwd("")
...
ResNorm_Alt
write.table(ResLFC_Alt,file = "DESeq_results_LCFShrinkResults-normal.txt", sep = "\t", row.names = FALSE)
