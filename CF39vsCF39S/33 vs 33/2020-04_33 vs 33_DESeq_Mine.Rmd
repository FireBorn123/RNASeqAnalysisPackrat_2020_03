...
#PC Path
setwd("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39vsCF39S/33 vs 33/My DESEQ Script")
#Laptop Path
#Set Library Directory
#.libPaths(c(""))
#setwd("")
...
#Actual Dataset
## Loading and formatting the CF39 vs CF39S 33 C Dataset
Load in the data from the file called "33 vs 33 Counts Table.csv". This file should be located along the specified path.

```{r}
#Load data data from my computer
Exp33_vs_33 <- read.csv("../../SourceRNASEQCountsForDESEQ/33 vs 33 Counts Table.csv")
TestSet <- Exp33_vs_33

#Variables
ColNameLables <- c("CF39S_33-1","CF39S_33-2", "CF39S_33-3", "CF39C_33-1","CF39C_33-2", "CF39C_33-3")
```
