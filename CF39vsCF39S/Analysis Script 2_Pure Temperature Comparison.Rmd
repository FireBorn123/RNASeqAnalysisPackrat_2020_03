...
#Combine full files
```{r}
LocusGeneAssociation <- read_csv("../25 vs 25/Locus_GeneNamesAndPredictedFunction.csv")
...
##Shrink 25vs25
```{r}
ColToRemove <- c("baseMean", "lfcSE", "stat", "padj_25C", "gene_name", "gene_discription", "raw_locus")
