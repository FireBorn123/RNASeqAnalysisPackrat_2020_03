...
HeatmapTest<- Heatmap(
       ...
       # row_names_max_width = unit(50, "mm"), #Does not appear to be doing anything
        right_annotation = rowAnnotation(
            Col1 = anno_text(TnT_List_Analysis_Shrunk2$locus,  gp = gpar(fontsize = RowLabelTextCell)), 
            Col2 = anno_text(TnT_List_Analysis_Shrunk2$Gene, gp = gpar(fontsize = RowLabelTextCell)),
          	label = anno_text(TnT_List_Analysis_Shrunk2$PAO1_ID, gp = gpar(fontsize = RowLabelTextCell)),
            gap = unit(2, "mm")),
