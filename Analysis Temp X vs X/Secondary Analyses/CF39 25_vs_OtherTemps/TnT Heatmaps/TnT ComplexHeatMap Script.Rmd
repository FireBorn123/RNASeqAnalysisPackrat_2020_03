...
HeatmapTest <- Heatmap(
        ...
        #row_labels = TnT_List_Analysis_Shrunk2$locus,
        right_annotation = rowAnnotation(Col1 = anno_text(TnT_List_Analysis_Shrunk2$locus, location = unit(2, "mm"), gp = gpar(fontsize = RowLabelTextCell)), 
                                         Col2 = anno_text(TnT_List_Analysis_Shrunk2$Gene, location = unit(5, "mm"), gp = gpar(fontsize = RowLabelTextCell)),
                                         Col3 = anno_text(EmptyColumn, location = unit(5, "mm"), gp = gpar(fontsize = RowLabelTextCell))),
...
#draw(HeatmapTest, heatmap_legend_side = "bottom", annotation_legend_side = "left")
