...
#PC Path
setwd("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39SvsCF39S/CF39S_33vs37/DESEQ Results")
#Laptop Path
#Set Library Directory
#.libPaths(c(""))
#setwd("")
...
Exp33_vs_37 <- read.csv("../../SourceDataTablesCF39SvsCF39S/CF39S 33vs37 Counts Table.csv")
TestSet <- Exp33_vs_37

#Variables
ColNameLables <- c("CF39SC33-1","CF39C33-2", "CF39SC33-3", "CF39ST37-1","CF39ST37-2", "CF39ST37-3")
```
