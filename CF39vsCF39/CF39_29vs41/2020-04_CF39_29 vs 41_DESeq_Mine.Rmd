...
#Actual Dataset
## Loading and formatting the CF39 29 vs 41C Dataset
Load in the data from the file called "CF39 29vs41 Counts Table.csv". This file should be located along the specified path.
