...
#Actual Dataset
## Loading and formatting the CF39 29 vs 33C Dataset
Load in the data from the file called "CF39 29vs33 Counts Table.csv". This file should be located along the specified path.
