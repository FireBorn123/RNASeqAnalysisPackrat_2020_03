...
The first thing you need to do is install all of the packages necessary for the analysis. The following chunk of code is for installing the edgeR package and dependencies in a Windows environment. Unfortunately when I tried installing all of the below packages on a MacBook Air, it did not work.
...
#PC Path
setwd("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39vsCF39/CF39_37vs41/DESEQ Results")
#Laptop Path
#Set Library Directory
#.libPaths(c(""))
#setwd("")
...
#Actual Dataset
## Loading and formatting the CF39 37 vs 41C Dataset
Load in the data from the file called "CF39 37vs41 Counts Table.csv". This file should be located along the specified path.

```{r}
#Load data data from my computer
Exp37_vs_41 <- read.csv("../../SourceDataTablesCF39vsCF39/CF39 37vs41 Counts Table.csv")
TestSet <- Exp37_vs_41

#Variables
ColNameLables <- c("CF39C37-1","CF39C37-2", "CF39C37-3", "CF39T41-1","CF39T41-2", "CF39T41-3")
```
...
```{r}
# A method of using equal length names to name the groups in the treatment. Essentially the colnames command is extracting the pre-existing column names from the TestSet dataframe, substring is extracting the first 2 characters of the column names, as specified by the characters inclusive between character 1 and 2 (so SC and ST), and finally these characters are being turned into factors.
