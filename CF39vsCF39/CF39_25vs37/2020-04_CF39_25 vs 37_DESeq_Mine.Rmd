...
#Actual Dataset
## Loading and formatting the CF39 25 vs 37C Dataset
Load in the data from the file called "CF39 25vs37 Counts Table.csv". This file should be located along the specified path.
