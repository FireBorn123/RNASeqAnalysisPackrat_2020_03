...
#Actual Dataset
## Loading and formatting the CF39 33 vs 37C Dataset
Load in the data from the file called "CF39 33vs37 Counts Table.csv". This file should be located along the specified path.
