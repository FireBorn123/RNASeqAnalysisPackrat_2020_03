...
#PC Path
setwd("E:/Dropbox/Dropbox/Harrison Lab - Trevor Randall/RNASeq Analysis/RNASeqAnlyPkrat_2020_03/CF39vsCF39/CF39_25vs41/DESEQ Results")
#Laptop Path
#Set Library Directory
#.libPaths(c(""))
#setwd("")
...
Exp25_vs_41 <- read.csv("../../SourceDataTablesCF39vsCF39/CF39 25vs41 Counts Table.csv")
TestSet <- Exp25_vs_41

#Variables
ColNameLables <- c("CF39C25-1","CF39C25-2", "CF39C25-3", "CF39T41-1","CF39T41-2", "CF39T41-3")
```
...
```{r}
expt_design <- data.frame(row.names = colnames(Treatment), condition = c("CF39T","CF39T","CF39T","CF39C","CF39C","CF39C"))
expt_design
